...
Guides for running and maintaining the MCP Static Scanner Validation Survey app.

## Contents

| Document | Contents |
| --- | --- |
| [deployment.md](deployment.md) | Hosting the app, secrets, and the Google Sheets backend |
| [data-format.md](data-format.md) | CSV column naming, value meanings, and analysis notes |
